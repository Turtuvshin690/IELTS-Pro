...
export const RESOURCES: StudyResource[] = [
  ...
  },
  {
    ...
    type: 'course',
    free: true,
    description: 'Free IELTS Ready: 6 skill-based tests + computer-delivered simulation + 40 tests & AI mini-mock — all free in this app.',
    tags: ['british-council', 'free'],
  },
  {
    id: 'british-ielts-ready',
    title: 'IELTS Ready — 40 Tests + Dashboard',
    provider: 'British Council',
    url: 'https://takeielts.britishcouncil.org/take-ielts/prepare',
    category: 'general',
    type: 'tool',
    free: true,
    description: '40 Listening/Reading tests, mini-mock with AI scores, personal progress dashboard — all free, no booking required.',
    tags: ['free', 'ai-scoring', 'dashboard'],
  },
  {
    id: 'cambridge-prep',
